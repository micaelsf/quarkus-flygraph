...
import com.github.micaelsf.mocks.MockProfilePropertiesT3;
...
@TestProfile(MockProfilePropertiesT3.class)
@TestInstance(TestInstance.Lifecycle.PER_CLASS)
@QuarkusTest
public class FlygraphTestT3 {
    ...
    void testRunMigration() {
        ...
        assertEquals("2-0-1-1-99", root.getCurrentVersion());
    }
    ...
    void testGetMigrationFilesOrder() {
        ...
        assertTrue(migrationFiles.get(1).getName().contains("V2-0-1-1-99"));
    }
}
